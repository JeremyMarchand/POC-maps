    ...
    <div>
        <div class="map_img">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                 y="0px" viewBox="0 0 667 578" xml:space="preserve">

<g class="region region-11" data-nom="Île-de-France" data-code_insee="11">
<path :class="(departmentSelectId === '75' ? 'isActive' : '')" data-nom="Paris" data-numerodepartement="75" @click="departmentClick('75', 'Paris')" class="region-11 departement departement-75 departement-paris"
      d="M396.8,154.7l-3.2-0.5l-2.5,1.7l3,3.5l5.3-0.1l-1.8-1.9L396.8,154.7z"></path>
    <path :class="(departmentSelectId === '77' ? 'isActive' : '')" data-nom="Seine-et-Marne" data-numerodepartement="77" @click="departmentClick('77', 'Seine-et-Marne')"
    ...
    <path :class="(departmentSelectId === '78' ? 'isActive' : '')" data-nom="Yvelines" data-numerodepartement="78" @click="departmentClick('78', 'Yvelines')"
    ...
    <path :class="(departmentSelectId === '91' ? 'isActive' : '')" data-nom="Essonne" data-numerodepartement="91" @click="departmentClick('91', 'Essonne')"
    ...
    <path :class="(departmentSelectId === '92' ? 'isActive' : '')" data-nom="Hauts-de-Seine" data-numerodepartement="92" @click="departmentClick('92', 'Hauts-de-Seine')"
          class="region-11 departement departement-92 departement-hauts-de-seine"
          d="M391.1,155.9l3,3.5l-0.4,4.1l-3.7-1.6v0.1l-3.2-5.2l2-3.1l3.6-2.6l1.3,2l-0.1,1.1L391.1,155.9z"></path>
    <path :class="(departmentSelectId === '93' ? 'isActive' : '')" data-nom="Seine-Saint-Denis" data-numerodepartement="93" @click="departmentClick('93', 'Seine-Saint-Denis')"
          class="region-11 departement departement-93 departement-seine-saint-denis"
          d="M404.7,152.7l-1.3,2.5l1.3,4.7v0.1l-7.1-2.6l-0.8-2.7l-3.2-0.5l0.1-1.1l-1.3-2l3.3-1.3l2.6,1.1 c1.6-1.1,3.2-2.2,4.7-3.3L404.7,152.7z"></path>
    <path :class="(departmentSelectId === '94' ? 'isActive' : '')" data-nom="Val-de-Marne" data-numerodepartement="94" @click="departmentClick('94', 'Val-de-Marne')"
          class="region-11 departement departement-94 departement-val-de-marne"
          d="M404.7,160l0.3,2.9l-1.1,4.1l-2.3-2.2l-2.8,0.8l-5.1-2.1l0.4-4.1l5.3-0.1l-1.8-1.9L404.7,160z "></path>
    <path :class="(departmentSelectId === '95' ? 'isActive' : '')" data-nom="Val-d’Oise" data-numerodepartement="95" @click="departmentClick('95', 'Val-d’Oise')"
...
<path :class="(departmentSelectId === '18' ? 'isActive' : '')" data-nom="Cher" data-numerodepartement="18" @click="departmentClick('18', 'Cher')" class="region-24 departement departement-18 departement-cher"
      d="m385.3,235.4l5-2.4l13.5,3.1l3.9,4.8l9-1.7l2,6.5l-1.7,5.8l2.7,2.1 l3.1,7.6l0.3,5.9l2.2,2l-0.2,5.8l-1.3,8.9h-0.1h-4l-4.8,3.7l-8.4,2.9l-2.3,1.9l1.7,5.3l-1.7,2.4l-8.7,1l-3.5,5.9v0.1l-4.9-0.2 l1.5-3.5l-0.9-8.9l-4.7-7.9l1.4-2.7l-2.3-2.2l2.5-5.1l-2.3-11.7l-11.6-1.6l2.8-5.5l2.8,0.1l0.6-2.8l9.7-2l-2.1-5.9l5.9-4.1 L385.3,235.4z"></path>
                    <path :class="(departmentSelectId === '28' ? 'isActive' : '')" data-nom="Eure-et-Loir" data-numerodepartement="28" @click="departmentClick('28', 'Eure-et-Loir')"
                    ...
                    <path :class="(departmentSelectId === '36' ? 'isActive' : '')" data-nom="Indre" data-numerodepartement="36" @click="departmentClick('36', 'Indre')"
                    ...
                    <path :class="(departmentSelectId === '37' ? 'isActive' : '')" data-nom="Indre-et-Loire" data-numerodepartement="37" @click="departmentClick('37', 'Indre-et-Loire')"
                    ...
                    <path :class="(departmentSelectId === '41' ? 'isActive' : '')" data-nom="Loir-et-Cher" data-numerodepartement="41" @click="departmentClick('41', 'Loir-et-Cher')"
                    ...
                    <path :class="(departmentSelectId === '45' ? 'isActive' : '')" data-nom="Loiret" data-numerodepartement="45" @click="departmentClick('45', 'Loiret')"
...
<path :class="(departmentSelectId === '21' ? 'isActive' : '')" data-nom="Côte-d’Or" data-numerodepartement="21" @click="departmentClick('21', 'Côte-d’Or')" class="region-27 departement departement-21 departement-cote-dor"
      d="m523.6,241.7l3.9,8.2l-1.2,1.3l-1.8,8.2 l-6.2,6.8l-1.1,4.1v-0.1l-15,1.5l-8.8,4.2l-5.6-6.3l-5.5-1.9l-1.3-2.6l-5.7-1.7l-2.4-2.6V260l0.4-3.2l-3.7-1.2l-1.3-6h0.1l-1.3-2.7 l1.3-8.1l6.7-10.4l-1.7-2.3l2.8-2.1l0.3-3.7l-3.1-3.9l1.9-3.1l2.2-2l6.1-0.9l4.7-3.9l3.9,0.5l3.5,0.7l0.5,2.7l2.6,1l-0.3,2.9 l2.9,0.3l1.8,2.2l1,3.1l-2.8,2.4l2.3,4.8l9.2,2l3,1.6v2.8l4.8-1.9h0.1l2.7-1.6l2,3l0.1,3.2l-4.6,4.1L523.6,241.7z"></path>
                    <path :class="(departmentSelectId === '25' ? 'isActive' : '')" data-nom="Doubs" data-numerodepartement="25" @click="departmentClick('25', 'Doubs')"
                    ...
                    <path :class="(departmentSelectId === '39' ? 'isActive' : '')" data-nom="Jura" data-numerodepartement="39" @click="departmentClick('39', 'Jura')"
                    ...
                    <path :class="(departmentSelectId === '58' ? 'isActive' : '')" data-nom="Nièvre" data-numerodepartement="58" @click="departmentClick('58', 'Nièvre')"
                    ...
                    <path :class="(departmentSelectId === '70' ? 'isActive' : '')" data-nom="Haute-Saône" data-numerodepartement="70" @click="departmentClick('70', 'Haute-Saône')"
                    ...
                    <path :class="(departmentSelectId === '71' ? 'isActive' : '')" data-nom="Saône-et-Loire" data-numerodepartement="71" @click="departmentClick('71', 'Saône-et-Loire')"
                    ...
                    <path :class="(departmentSelectId === '89' ? 'isActive' : '')" data-nom="Yonne" data-numerodepartement="89" @click="departmentClick('89', 'Yonne')"
                    ...
                    <path :class="(departmentSelectId === '90' ? 'isActive' : '')" data-nom="Territoire de Belfort" data-numerodepartement="90" @click="departmentClick('90', 'Territoire de Belfort')"
...
<path :class="(departmentSelectId === '14' ? 'isActive' : '')" data-nom="Calvados" data-numerodepartement="14" @click="departmentClick('14', 'Calvados')" class="region-28 departement departement-14 departement-calvados"
      d="m316.9,148l-0.7,2.2l-5.6-1l-7,1.7l-7.2,5.4 l-2.9,0.3l-5.7-1.1l-2.6,1.7l-4.9-3l-6.4,2.3l-2.7-1.3l-0.9,2.7l-5.4,2.9l-9.7-2.1l-1.8-2.4l4.5-5.3l-1.6-2.3l8.1-4.9l-2.2-8.2 l2-2.6l-8.4-3.1l-0.5-6.6v-0.1l0.1-0.7l1.8,0.8l1.9-2.1l3.4-0.3l9.4,3.3l13.9,1.5l6.9,3.4l5.7-0.7l4.7-2.5l4.1-3.7l5.1-1.1l0.3,8.3 h2.9l-2.3,2.1l2.8,9.4l-1.4,3L316.9,148z"></path>
                    <path :class="(departmentSelectId === '27' ? 'isActive' : '')" data-nom="Eure" data-numerodepartement="27" @click="departmentClick('27', 'Eure')"
                    ...
                    <path :class="(departmentSelectId === '50' ? 'isActive' : '')" data-nom="Manche" data-numerodepartement="50" @click="departmentClick('50', 'Manche')"
                    ...
                    <path :class="(departmentSelectId === '61' ? 'isActive' : '')" data-nom="Orne" data-numerodepartement="61" @click="departmentClick('61', 'Orne')"
                    ...
                    <path :class="(departmentSelectId === '76' ? 'isActive' : '')" data-nom="Seine-Maritime" data-numerodepartement="76" @click="departmentClick('76', 'Seine-Maritime')"
...
<path :class="(departmentSelectId === '02' ? 'isActive' : '')" data-nom="Aisne" data-numerodepartement="02" @click="departmentClick('02', 'Aisne')" class="region-32 departement departement-02 departement-aisne"
      d="m450.3,82.6l16.7,4.6l2.91,0.94L470.6,94l-1.3,3.5l1.3,3.1l-5,7.2 l-2.7,0.3l0.3,14.3l-1,2.8l-5.3-1.8l-8,4l-1.2,2.6l3.2,8l-5.5,2.3l1.6,2.4l-0.8,2.7l2.5,1.3l-7.7,10.2l-9.3-6l-3.9-4.2l0.7-2.8 l-1.8-2.5l-2.6-0.7l2.1-1.7l-0.5-2.8l-2.9-1.1l-2.4,1.5l-0.7-2.9l3,0.2l-2.9-4.5l2.6-1.7l2.4-5.7l2.6-1.1l-2.2-1.8l0.8-4.5 l-0.4-10.2l-2.3-7l3.9-8.1l0.4-3.8l12.6-0.6l2.6-2.2l2.3,1.7L450.3,82.6z"></path>
                    <path :class="(departmentSelectId === '59' ? 'isActive' : '')" data-nom="Nord" data-numerodepartement="59" @click="departmentClick('59', 'Nord')"
                    ...
                    <path :class="(departmentSelectId === '60' ? 'isActive' : '')" data-nom="Oise" data-numerodepartement="60" @click="departmentClick('60', 'Oise')"
                    ...
                    <path :class="(departmentSelectId === '62' ? 'isActive' : '')" data-nom="Pas-de-Calais" data-numerodepartement="62" @click="departmentClick('62', 'Pas-de-Calais')"
                    ...
                    <path :class="(departmentSelectId === '80' ? 'isActive' : '')" data-nom="Somme" data-numerodepartement="80" @click="departmentClick('80', 'Somme')"
...
<path :class="(departmentSelectId === '08' ? 'isActive' : '')" data-nom="Ardennes" data-numerodepartement="08" @click="departmentClick('08', 'Ardennes')" class="region-44 departement departement-08 departement-ardennes"
      d="m469.91,88.14l0.79,0.26l9.8,0.4l7.3-3.2l1.1-6 l4-3.8l2.8-0.2v3.8L494,81l-0.6,5.2l3.3,4.5l-1,2.4l0.6,3.1l1.4,1.9l3.3-0.9l4.3,2.4l2.8,3.8l4.9,0.6l2,1.7l-0.9,2.4l2.1-0.13 l-1.6,1.13l-2,2.7l-5.7-2.1l-1.9,2l0.8,8.8l-3.2,5.1l1.4,2.5l-4.2,3.6v0.1l-20.1-1.9l-9.8-6.6l-6.7-0.9l-0.3-14.3l2.7-0.3l5-7.2 l-1.3-3.1l1.3-3.5L469.91,88.14z"></path>
                    <path :class="(departmentSelectId === '10' ? 'isActive' : '')" data-nom="Aube" data-numerodepartement="10" @click="departmentClick('10', 'Aube')"
                    ...
                    <path :class="(departmentSelectId === '51' ? 'isActive' : '')" data-nom="Marne" data-numerodepartement="51" @click="departmentClick('51', 'Marne')"
                    ...
                    <path :class="(departmentSelectId === '52' ? 'isActive' : '')" data-nom="Haute-Marne" data-numerodepartement="52" @click="departmentClick('52', 'Haute-Marne')"
                    ...
                    <path :class="(departmentSelectId === '54' ? 'isActive' : '')" data-nom="Meurthe-et-Moselle" data-numerodepartement="54" @click="departmentClick('54', 'Meurthe-et-Moselle')"
                    ...
                    <path :class="(departmentSelectId === '55' ? 'isActive' : '')" data-nom="Meuse" data-numerodepartement="55" @click="departmentClick('55', 'Meuse')"
                    ...
                    <path :class="(departmentSelectId === '57' ? 'isActive' : '')" data-nom="Moselle" data-numerodepartement="57" @click="departmentClick('57', 'Moselle')"
                    ...
                    <path :class="(departmentSelectId === '67' ? 'isActive' : '')" data-nom="Bas-Rhin" data-numerodepartement="67" @click="departmentClick('67', 'Bas-Rhin')"
                    ...
                    <path :class="(departmentSelectId === '68' ? 'isActive' : '')" data-nom="Haut-Rhin" data-numerodepartement="68" @click="departmentClick('68', 'Haut-Rhin')"
                    ...
                    <path :class="(departmentSelectId === '88' ? 'isActive' : '')" data-nom="Vosges" data-numerodepartement="88" @click="departmentClick('88', 'Vosges')"
...
<path :class="(departmentSelectId === '44' ? 'isActive' : '')" data-nom="Loire-Atlantique" data-numerodepartement="44" @click="departmentClick('44', 'Loire-Atlantique')"
      ...
      d="m213.1,265.2l1.8-1l-2.8-4.1l-7.8-3l3-1.3 l0.6-2.2l-0.5-2.5l1.4-2.1l5.8-1.1l-5.5-0.7l-6.6,3.7l-4.1-3.2l-2.2,1l-2.2-1.2l-0.5-4.9l0.9-2.5l3-0.5l-0.9-2.2l-0.18-0.31 l13.18-3.89l0.4-6l5.2-3.4l13.2-0.4l1.6-2.9l9-3.9l6.8,3.6l7.2,13.3l-2.7-0.4l-1.9,2.4l8.5,3.3l0.3,5.9l-14.3,2.1l-2.9,2.2l3,0.8 l3.6,4.7l0.8,2.8l-2.8,4.5l2.8,1.4l0.4,3l-4.8-3.5l-1.5,2.4l-3.2,0.7l0.5,3l-2.4,2.1l-2.3-1.7v-3.1l-3.4,0.2l-0.2,9.5l-11.7-5 L213.1,265.2z"></path>
                    <path :class="(departmentSelectId === '49' ? 'isActive' : '')" data-nom="Maine-et-Loire" data-numerodepartement="49" @click="departmentClick('49', 'Maine-et-Loire')"
                    ...
                    <path :class="(departmentSelectId === '53' ? 'isActive' : '')" data-nom="Mayenne" data-numerodepartement="53" @click="departmentClick('53', 'Mayenne')"
                    ...
                    <path :class="(departmentSelectId === '72' ? 'isActive' : '')" data-nom="Sarthe" data-numerodepartement="72" @click="departmentClick('72', 'Sarthe')"
                    ...
                    <path :class="(departmentSelectId === '85' ? 'isActive' : '')" data-nom="Vendée" data-numerodepartement="85" @click="departmentClick('85', 'Vendée')"
...
<path :class="(departmentSelectId === '22' ? 'isActive' : '')" data-nom="Côtes-d’Armor" data-numerodepartement="22" @click="departmentClick('22', 'Côtes-d’Armor')"
      ...
      d="m208.7,188.9l-4.9,7.1l-2.9,1.1l-1.5-2.7 l-3.5-0.9l-6.2,7.5l-1.8-6l-3,0.9l-12.9-6.5l-7.9,3l-12.46-3.29l2.06-4.11l-2.5-9.3l2.5-8.3l-3.6-4.7l1.1-4.3l1.2,1.4l3.2-0.4 l1.1-7.7l1.5-1.6l2.2-0.6l1.9,1.4h2.5l2.1-1l2.2,0.3l1.5-1.8l0.9,2L170,153l3-3.6l2.9-0.8l-0.1,2.3l-1.2,4.4l1.7-3.1l2.6-0.5l-1.1,2 l7.2,7.8l2.2,5.4l3,2l0.8,3.7l0.7-2.2l3-1l2.4-2.7l8.1-3.3l2.7-0.2l-2,2.5l2.9-1.1l1.8,4.4l1.3-1.9l2.5,0.2v-0.09l1.6,3.99h-0.3h0.3 l2.5,0.3l0.7,0.2l0.4,1.7l-1.9,13L208.7,188.9z"></path>
                    <path :class="(departmentSelectId === '29' ? 'isActive' : '')" data-nom="Finistère" data-numerodepartement="29" @click="departmentClick('29', 'Finistère')"
                    ...
                    <path :class="(departmentSelectId === '35' ? 'isActive' : '')" data-nom="Ille-et-Vilaine" data-numerodepartement="35" @click="departmentClick('35', 'Ille-et-Vilaine')"
                    ...
                    <path :class="(departmentSelectId === '56' ? 'isActive' : '')" data-nom="Morbihan" data-numerodepartement="56" @click="departmentClick('56', 'Morbihan')"
...
<path :class="(departmentSelectId === '16' ? 'isActive' : '')" data-nom="Charente" data-numerodepartement="16" @click="departmentClick('16', 'Charente')" class="region-75 departement departement-16 departement-charente"
      d="m294.8,379.2l-2,2v-0.1l-6.3-6.3l-6-1.2l1.7-3l-2.3-2l2.4-1.7l-1.5-2.6 l1.7-2.6l-2.4-1.7l-0.3-3l-5-3.1l2.2-2.1l-3.2-5.6l8.1-3.3l2.3,2l2.7-0.1l2.7-11.6l2.7-1.6l0.3-3l5.8-2.5l3.5,0.4l0.8-0.8h0.1l9.1,3 l2.9-0.8l-1.4-2.4l2.2-1.8l4.1,3.9l3.8-1.4l1.3-2.5l4.8,0.6l-0.2,5.1l4.7,3.6l-0.6,3.2l-2.6,1.1l-4,8l-2.8,0.6l-3.4,3.8h0.1 l-5.7,6.1l-2.1,5.3l-7.9,5.9l-0.7,5.7l-4.1,5.8L294.8,379.2z"></path>
                    <path :class="(departmentSelectId === '17' ? 'isActive' : '')" data-nom="Charente-Maritime" data-numerodepartement="17" @click="departmentClick('17', 'Charente-Maritime')"
                    ...
                    <path :class="(departmentSelectId === '19' ? 'isActive' : '')" data-nom="Corrèze" data-numerodepartement="19" @click="departmentClick('19', 'Corrèze')"
                    ...
                    <path :class="(departmentSelectId === '23' ? 'isActive' : '')" data-nom="Creuse" data-numerodepartement="23" @click="departmentClick('23', 'Creuse')"
                    ...
                    <path :class="(departmentSelectId === '24' ? 'isActive' : '')" data-nom="Dordogne" data-numerodepartement="24" @click="departmentClick('24', 'Dordogne')"
                    ...
                    <path :class="(departmentSelectId === '33' ? 'isActive' : '')" data-nom="Gironde" data-numerodepartement="33" @click="departmentClick('33', 'Gironde')"
                    ...
                    <path :class="(departmentSelectId === '40' ? 'isActive' : '')" data-nom="Landes" data-numerodepartement="40" @click="departmentClick('40', 'Landes')"
                    ...
                    <path :class="(departmentSelectId === '47' ? 'isActive' : '')" data-nom="Lot-et-Garonne" data-numerodepartement="47" @click="departmentClick('47', 'Lot-et-Garonne')"
                    ...
                    <path :class="(departmentSelectId === '64' ? 'isActive' : '')" data-nom="Pyrénées-Atlantiques" data-numerodepartement="64" @click="departmentClick('64', 'Pyrénées-Atlantiques')"
                    ...
                    <path :class="(departmentSelectId === '79' ? 'isActive' : '')" data-nom="Deux-Sèvres" data-numerodepartement="79" @click="departmentClick('79', 'Deux-Sèvres')"
                    ...
                    <path :class="(departmentSelectId === '86' ? 'isActive' : '')" data-nom="Vienne" data-numerodepartement="86" @click="departmentClick('86', 'Vienne')"
                    ...
                    <path :class="(departmentSelectId === '87' ? 'isActive' : '')" data-nom="Haute-Vienne" data-numerodepartement="87" @click="departmentClick('87', 'Haute-Vienne')"
...
<path :class="(departmentSelectId === '09' ? 'isActive' : '')" data-nom="Ariège" data-numerodepartement="09" @click="departmentClick('09', 'Ariège')" class="region-76 departement departement-09 departement-ariege"
      d="m369.82,543.59l0.78-0.89l-2.6-1.1l-2-2.1 l-3.7-0.1l-1.7-1.7l-2.8,0.4l-1.3,2.1l-2.4-0.8l-2.8-5.9l-10-0.6l-1.3-2.8l-13.2-3.9l-0.5-1.4l3.8-5.2l2.8-1v-5.9l3.9-4l2.8-1.1 l6.2,4.1l-0.4-5.6l5.4-1.6l-3-4.8l2.8-1.1l3.4,5.5l2.8-0.5l0.6-2.8l5.7,2.2l2-2.3l2.2,5.5l8.7,3.9l2.2,5.2l0.2,3.1l-2.2,2.3l2.4,2.5 l-1.2,3l-3.2,0.6l0.8,5.7l3.4,1.5l3.3-1.2l4.8,5.6l-7.4,0.2l-1.3,2.6L369.82,543.59z"></path>
                    <path :class="(departmentSelectId === '11' ? 'isActive' : '')" data-nom="Aude" data-numerodepartement="11" @click="departmentClick('11', 'Aude')"
                    ...
                    <path :class="(departmentSelectId === '12' ? 'isActive' : '')" data-nom="Aveyron" data-numerodepartement="12" @click="departmentClick('12', 'Aveyron')"
                    ...
                    <path :class="(departmentSelectId === '30' ? 'isActive' : '')" data-nom="Gard" data-numerodepartement="30" @click="departmentClick('30', 'Gard')"
                    ...
                    <path :class="(departmentSelectId === '31' ? 'isActive' : '')" data-nom="Haute-Garonne" data-numerodepartement="31" @click="departmentClick('31', 'Haute-Garonne')"
                    ...
                    <path :class="(departmentSelectId === '32' ? 'isActive' : '')" data-nom="Gers" data-numerodepartement="32" @click="departmentClick('32', 'Gers')"
                    ...
                    <path :class="(departmentSelectId === '34' ? 'isActive' : '')" data-nom="Hérault" data-numerodepartement="34" @click="departmentClick('34', 'Hérault')"
                    ...
                    <path :class="(departmentSelectId === '46' ? 'isActive' : '')" data-nom="Lot" data-numerodepartement="46" @click="departmentClick('46', 'Lot')"
                    ...
                    <path :class="(departmentSelectId === '48' ? 'isActive' : '')" data-nom="Lozère" data-numerodepartement="48" @click="departmentClick('48', 'Lozère')"
                    ...
                    <path :class="(departmentSelectId === '65' ? 'isActive' : '')" data-nom="Hautes-Pyrénées" data-numerodepartement="65" @click="departmentClick('65', 'Hautes-Pyrénées')"
                    ...
                    <path :class="(departmentSelectId === '66' ? 'isActive' : '')" data-nom="Pyrénées-Orientales" data-numerodepartement="66" @click="departmentClick('66', 'Pyrénées-Orientales')"
                    ...
                    <path :class="(departmentSelectId === '81' ? 'isActive' : '')" data-nom="Tarn" data-numerodepartement="81" @click="departmentClick('81', 'Tarn')"
                    ...
                    <path :class="(departmentSelectId === '82' ? 'isActive' : '')" data-nom="Tarn-et-Garonne" data-numerodepartement="82" @click="departmentClick('82', 'Tarn-et-Garonne')"
...
<path :class="(departmentSelectId === '01' ? 'isActive' : '')" data-nom="Ain" data-numerodepartement="01" @click="departmentClick('01', 'Ain')" class="region-84 departement departement-01 departement-ain"
      d="m542,347l-5.7,6.7l-11.2-15.2l-2.8,0.7l-3,5.1 l-6-2l-6.4,0.5l-3.7-5.7l-2.8,0.5l-3.1-9.2l1.5-8l5.9-20.9l5.9,1.5l5.4-1.3l4.8,3.3l4.3,7.7h2.9l0.1,3l2.9-0.1l4-4.4l3.4,1.6 l0.4,2.8l3.8-0.2l5.5-3.2l5.3-7.2l4.5,2.7l-1.8,4.7l0.3,2.5l-4.4,1.5l-1.9,2l0.2,2.8l0.46,0.19l-4.36,4.71h-2.9l0.8,9.3L542,347z"></path>
                    <path :class="(departmentSelectId === '03' ? 'isActive' : '')" data-nom="Allier" data-numerodepartement="03" @click="departmentClick('03', 'Allier')"
                    ...
                    <path :class="(departmentSelectId === '07' ? 'isActive' : '')" data-nom="Ardèche" data-numerodepartement="07" @click="departmentClick('07', 'Ardèche')"
                    ...
                    <path :class="(departmentSelectId === '15' ? 'isActive' : '')" data-nom="Cantal" data-numerodepartement="15" @click="departmentClick('15', 'Cantal')"
                    ...
                    <path :class="(departmentSelectId === '26' ? 'isActive' : '')" data-nom="Drôme" data-numerodepartement="26" @click="departmentClick('26', 'Drôme')"
                    ...
                    <path :class="(departmentSelectId === '38' ? 'isActive' : '')" data-nom="Isère" data-numerodepartement="38" @click="departmentClick('38', 'Isère')"
                    ...
                    <path :class="(departmentSelectId === '42' ? 'isActive' : '')" data-nom="Loire" data-numerodepartement="42" @click="departmentClick('42', 'Loire')"
                    ...
                    <path :class="(departmentSelectId === '43' ? 'isActive' : '')" data-nom="Haute-Loire" data-numerodepartement="43" @click="departmentClick('43', 'Haute-Loire')"
                    ...
                    <path :class="(departmentSelectId === '63' ? 'isActive' : '')" data-nom="Puy-de-Dôme" data-numerodepartement="63" @click="departmentClick('63', 'Puy-de-Dôme')"
                    ...
                    <path :class="(departmentSelectId === '69' ? 'isActive' : '')" data-nom="Rhône" data-numerodepartement="69" @click="departmentClick('69', 'Rhône')"
                    ...
                    <path :class="(departmentSelectId === '73' ? 'isActive' : '')" data-nom="Savoie" data-numerodepartement="73" @click="departmentClick('73', 'Savoie')"
                    ...
                    <path :class="(departmentSelectId === '74' ? 'isActive' : '')" data-nom="Haute-Savoie" data-numerodepartement="74" @click="departmentClick('74', 'Haute-Savoie')"
...
<path :class="(departmentSelectId === '04' ? 'isActive' : '')" data-nom="Alpes-de-Haute-Provence" data-numerodepartement="04" @click="departmentClick('04', 'Alpes-de-Haute-Provence')"
      ...
      d="m596.5,409.9l0.57-0.5l-0.37,4.5l-2.2,1.5 l-0.6,2.9l3.5,4l-1.8,4.8l0.19,0.21L589,435.1l-2,5.3l4.3,8.5l7,7.7l-5.2-0.6l-5.2,3.8l1.2,2.6l-3,1.4l-9.8,0.4l-1.2,3.5l-5.9-3.6 l-10.1,8.5l-4-4.8l-2.7,1.8l-5.3-0.2l-6.1-6l-3.4-1.1l1.7-2.5l-3.7-5.2l1.2-3l-2.2-5.4l4.3-4.8l2.3-0.1l1-0.2l5.9-1.4l3.8,1 l-3.4-4.9l3.9,1.1l1.4-8.6l5.3-4l3.3-0.7l3.5,4.5l0.7-3.8l3.8-4.2l11.1,3.3l9-10.2L596.5,409.9z"></path>
                    <path :class="(departmentSelectId === '05' ? 'isActive' : '')" data-nom="Hautes-Alpes" data-numerodepartement="05" @click="departmentClick('05', 'Hautes-Alpes')"
                    ...
                    <path :class="(departmentSelectId === '06' ? 'isActive' : '')" data-nom="Alpes-Maritimes" data-numerodepartement="06" @click="departmentClick('06', 'Alpes-Maritimes')"
                    ...
                    <path :class="(departmentSelectId === '13' ? 'isActive' : '')" data-nom="Bouches-du-Rhône" data-numerodepartement="13" @click="departmentClick('13', 'Bouches-du-Rhône')"
                    ...
                    <path :class="(departmentSelectId === '83' ? 'isActive' : '')" data-nom="Var" data-numerodepartement="83" @click="departmentClick('83', 'Var')"
                    ...
                    <path :class="(departmentSelectId === '84' ? 'isActive' : '')" data-nom="Vaucluse" data-numerodepartement="84" @click="departmentClick('84', 'Vaucluse')"
...
<path :class="(departmentSelectId === '2A' ? 'isActive' : '')" data-nom="Corse-du-Sud" data-numerodepartement="2A" @click="departmentClick('2A', 'Corse-du-Sud')"
      ...
      d="m640.5,554.2l3.2-1.7l0.7,8.4l-0.15,0.54 l-1.85,4.86l-2.7,1.9l3.3,0.4l-5.8,14.7l-3.1-1.2l-1.2-2.8l-11.2-3.4l-4.8-4.4l0.2-3l4.9-3.3l-9.5-1.9l2.7-7l-0.9-5.8l-7.3,2.6 l3-8.4l2.6-1.6l-7.9-4.4l-1.1-5.5l5.3-3.8l-3.8-4.2l-2.6,1l0.5-2.7l13.6,2.1l1.2,3.5l6,3.4l6,5.9l0.5,3.2l2.7,1.1l3.7,11 L640.5,554.2z"></path>
                    <path :class="(departmentSelectId === '2B' ? 'isActive' : '')" data-nom="Haute-Corse" data-numerodepartement="2B" @click="departmentClick('2B', 'Haute-Corse')"
        ...
        <div class="map_list">
            <h2 v-if="departmentSelectId && departmentSelect">Département sélectionné : {{ departmentSelect }}</h2>
            <h2 v-else>Département sélectionné : Aucun</h2>
        </div>
    </div>
</template>
<script>
    export default {
        name: 'map-department',
        methods: {
            departmentClick: function (regionId, region) {
                if (this.departmentSelectId === regionId) {
                    this.departmentSelectId = null;
                    this.departmentSelect = null;
                } else {
                    this.departmentSelectId = regionId;
                    this.departmentSelect = region;
                }
            }
        },
        data() {
